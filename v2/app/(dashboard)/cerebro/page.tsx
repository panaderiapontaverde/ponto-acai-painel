    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">
          ...
          transacional. Sem sessão autenticada, esta leitura pode aparecer vazia por RLS (proteção
          deliberada; peça liberação explícita se quiser leitura aberta aqui).
        </p>
      </div>
