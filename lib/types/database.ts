...
export interface SalesSnapshot {
  ...
  /** Faturamento do período. Nome real da coluna — não existe `revenue`. */
  total_value: number | null;
  /** Quantidade de pedidos. Nome real da coluna — não existe `orders_count`. */
  total_sales: number | null;
  /** Ticket médio. Nome real da coluna — não existe `average_ticket`. */
